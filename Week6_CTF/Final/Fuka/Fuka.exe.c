...
int __thiscall sub_4024DF(_DWORD *this, int n4, int, int, int, int, unsigned int n0x10); // idb
...
int __cdecl main(int argc, const char **argv, const char **envp)
{
  ...
  _DWORD *v9; // eax
  int v10; // eax
  unsigned int n3_2; // esi
  char v12; // al
  const char *[_]_Correct_; // edx
  int v14; // eax
  int v16[5]; // [esp-18h] [ebp-64h] BYREF
  unsigned int n0x10; // [esp-4h] [ebp-50h]
  void *Block; // [esp+10h] [ebp-3Ch] BYREF
  unsigned int n3_1; // [esp+14h] [ebp-38h]
  _DWORD *Src[4]; // [esp+18h] [ebp-34h] BYREF
  int n30; // [esp+28h] [ebp-24h]
  int n15; // [esp+2Ch] [ebp-20h]
  _DWORD *v23; // [esp+30h] [ebp-1Ch] BYREF
  ...
  i = std::ios::widen(std::cin + *(_DWORD *)(std::cin + 4), 10);
  sub_404CD6(Src, std::cin, i);
  if ( n30 == 30 )
  {
    ...
    LOBYTE(v26) = 2;
    sub_4045CA(v16, Src);
    v7 = (_DWORD **)sub_4024DF(v6, v16[0], v16[1], v16[2], v16[3], v16[4], n0x10);
    LOBYTE(v26) = 1;
    ...
    do
    {
      ...
      *v9 = 0;
      ...
      sub_404E21(
        (char **)&v23,
        *(char **)(dword_40A400 + 8 * n3),
        *(_DWORD *)(dword_40A400 + 8 * n3) + *(_DWORD *)(dword_40A400 + 8 * n3 + 4),
        (int)Block);
      v10 = 1 << (n3_1 & 0x1F);
      n3_2 = n3_1;
      LOBYTE(v10) = (v10 & ::Block[n3_1 >> 5]) != 0;
      ((void (__thiscall *)(_DWORD **, unsigned int, _DWORD **, int))(*v7)[2])(v7, n3_1, &v23, v10);
      LOBYTE(v26) = 1;
      if ( v23 )
      {
        sub_403795(v23, v25 - (char *)v23);
        v23 = 0;
        v24 = 0;
        v25 = 0;
      }
    ...
    if ( !v12 )
      [_]_Correct_ = "[!] Wrong!";
    v14 = sub_4048B4(std::cout, [_]_Correct_);
